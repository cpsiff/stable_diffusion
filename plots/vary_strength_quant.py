...
# ax.set_title("Effect of Diffusion Strength on SSIM - Color Quantization\nGuidance Scale Fixed at 10")
ax.plot([0.0, 0.5], [0.898, 0.898], ls="--", c="gray") # doing nothing
ax.plot([0.0, 0.5], [0.903, 0.903], ls="--", c="green") # deepdeband
ax.set_ylim(0, 1.0)

plt.tight_layout()
plt.savefig("vary_strength_quant.pdf", dpi=500)
plt.show()