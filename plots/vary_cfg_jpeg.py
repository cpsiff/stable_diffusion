...
# ax.set_title("Effect of Guidance Scale on SSIM - JPEG Compression \n Diffusion strength fixed at 0.3")
ax.set_ylim(0, 1.0)
ax.plot([0, 30], [0.799, 0.799], ls="--", c="gray") # doing nothing at all
ax.plot([0, 30], [0.821, 0.821], ls="--", c="green") # state-of-the-art

plt.tight_layout()
plt.savefig("vary_cfg_jpeg.pdf", dpi=500)
plt.show()